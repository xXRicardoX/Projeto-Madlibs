def madlib():
    ...
    verb = input("Verbo: ")
    verb2 = input("Verbo: ")
    noun = input("substantivos: ")
    noun2 = input("substantivos: ")
    noun3 = input("substantivos: ")
    noun4 = input("substantivos: ")
    noun5 = input("Nousubstantivos: ")
    noun_plural = input("substantivos (plural): ")
    noun_plural_2 = input("substantivos (plural): ")
    noun_plural_3 = input("substantivos (plural): ")
    sound_important = input("Nome de algo que soa importante: ")
