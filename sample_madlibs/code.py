def madlib():
    body_part = input("Parte do corpo: ")
    verb = input("Verbo: ")
    adj1 = input("Adjetivos: ")
    adj2 = input("Adjetivos: ")
    adj3 = input("Adjetivos ")
    adj4 = input("Adjetivos: ")
    adj5 = input("Adjetivos: ")
    noun1 = input("substantivos: ")
